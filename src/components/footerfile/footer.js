            ...
            <div className={Classes.footerBlock}>
                <div className={Classes.firstSect}>
                    <div className={Classes.introText}>
                        <p>I am a frontend webdeveloper buiding optimized applications to suite your needs, reach out to me via my contact means i would be responding as soon as possible after a review of your message. Waiting to hear from you</p>
                    </div>
